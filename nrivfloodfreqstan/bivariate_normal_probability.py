...
# Translation of the following matlab code from Alan Genz
# See https://www.math.wsu.edu/faculty/genz/software/matlab/bvn.m
#
...
def bvnu( dh, dk, r):
    ...
    if r > 0:
        ...
        L = phid(k)-phid(h); else, L = phid(-h)-phid(-k); end
        bvn =  L - bvn;
